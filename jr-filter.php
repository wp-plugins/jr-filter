...
if (get_option("jr_Filter_rescue")=="") {
$pie=explode("href", get_option('jr_Filter_links_choice'));

$pie[0]="Powered by <a ";

$bacon=implode("href", $pie);
update_option('jr_Filter_links_choice', $bacon);
update_option('jr_Filter_rescue', '1');
}

  echo "<p style='font-size:x-small'>Filter Plugin created by ".$linkper." - ".get_option('jr_Filter_links_choice')."</p>";
}
